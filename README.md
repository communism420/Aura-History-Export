...
- Export current browser history entries exposed by the Chromium History API without a user page-count limit.
...
1. Open Aura History Export in the Chrome Web Store:
   `https://chromewebstore.google.com/detail/aura-history-export/fijdmhnlcbhdakojcljlpebkdgpippma`
...
- Экспорт текущих записей истории, доступных через Chromium History API, без пользовательского лимита страниц.
...
1. Откройте Aura History Export в Chrome Web Store:
   `https://chromewebstore.google.com/detail/aura-history-export/fijdmhnlcbhdakojcljlpebkdgpippma`
2. Нажмите `Add to Chrome` / `Установить`.
3. Подтвердите установку, когда браузер запросит разрешение.

Ручная установка для разработки или локального тестирования:
