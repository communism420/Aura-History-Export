...
3. Enable Beginner mode if it is not already enabled, then export the last 7 days using the default file type.
4. Disable Beginner mode to access expert controls.
